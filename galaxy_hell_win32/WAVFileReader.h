...
namespace DirectX
{
    ...
    HRESULT LoadWAVAudioFromFile(::gpk::vcc szFileName, _Inout_ ::gpk::array_pod<uint8_t>& wavData, _Outptr_ const WAVEFORMATEX** wfx, ::gpk::view_array<const uint8_t>& audioView) noexcept;
    ...
    HRESULT LoadWAVAudioFromFileEx(::gpk::vcc szFileName, _Inout_ ::gpk::array_pod<uint8_t>& wavData, _Out_ WAVData& result) noexcept;
}
