...
::gpk::error_t		ssg::ssiegeServerUpdate		(::ssg::SSSiegeServer & app, double lastTimeSeconds, const ::gpk::pobj<::gpk::SInput> & inputState, ::gpk::vpobj<::gpk::SSystemEvent> systemEvents) { 
	gpk_necs(::ssg::ssiegeUpdate(app, lastTimeSeconds, inputState, systemEvents, [&app](::gpk::pobj<::ssg::EventSSiege> & _eventToProcess, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) {
		...
		case ::ssg::SSG_EVENT_CHAR_ACTION: { es_if_failed(result = ::ssg::eventExtractAndHandle<::ssg::CHAR_ACTION>(eventToProcess, [&app, &outputEvents](auto ev){ return ::ssg::handleCHAR_ACTION(app, ev, outputEvents); })); break; }
		case ::ssg::SSG_EVENT_ADMIN_WORLD: { es_if_failed(result = ::ssg::eventExtractAndHandle<::ssg::ADMIN_WORLD>(eventToProcess, [&app, &outputEvents](auto ev){ return ::ssg::handleADMIN_WORLD(app, ev, outputEvents); })); break; }
		case ::ssg::SSG_EVENT_WORLD_EVENT: { es_if_failed(result = ::ssg::eventExtractAndHandle<::ssg::WORLD_EVENT>(eventToProcess, [&app, &outputEvents](auto ev){ return ::ssg::handleWORLD_EVENT(app, ev, outputEvents); })); break; }
		case ::ssg::SSG_EVENT_CLIENT_ASKS: { es_if_failed(result = ::ssg::eventExtractAndHandle<::ssg::CLIENT_ASKS>(eventToProcess, [&app, &outputEvents](auto ev){ return ::ssg::handleCLIENT_ASKS(app, ev, outputEvents); })); break; }
		case ::ssg::SSG_EVENT_WORLD_SETUP: { es_if_failed(result = ::ssg::eventExtractAndHandle<::ssg::WORLD_SETUP>(eventToProcess, [&app, &outputEvents](auto ev){ return ::ssg::handleWORLD_SETUP(app, ev, outputEvents); })); break; }
		case ::ssg::SSG_EVENT_WORLD_VALUE: { es_if_failed(result = ::ssg::eventExtractAndHandle<::ssg::WORLD_VALUE>(eventToProcess, [&app, &outputEvents](auto ev){ return ::ssg::handleWORLD_VALUE(app, ev, outputEvents); })); break; }
		default: 
...
::gpk::error_t	ssg::handleCHAR_ACTION		(::ssg::SSSiegeServer & app, const ::ssg::EViewMinime & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { 
...
::gpk::error_t	ssg::handleADMIN_WORLD		(::ssg::SSSiegeServer & app, const ::ssg::EViewAdminWorld & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { 
	(void)outputEvents; (void)app; 
	const ::ssg::SArgsEvent	& eventArgs		= *(const ::ssg::SArgsEvent*)gameEvent.Data.begin();
	::ssg::printArgsEvent(eventArgs);
	switch(gameEvent.Type) { 
...
::gpk::error_t	ssg::handleWORLD_EVENT		(::ssg::SSSiegeServer & app, const ::ssg::EViewWorld & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { 
	(void)outputEvents; (void)app; 
	const ::ssg::SArgsEvent	& eventArgs		= *(const ::ssg::SArgsEvent*)gameEvent.Data.begin();
	::ssg::printArgsEvent(eventArgs);
	switch(gameEvent.Type) { 
...
::gpk::error_t	ssg::handleCLIENT_ASKS		(::ssg::SSSiegeServer & app, const ::ssg::EViewClient & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { 
	(void)outputEvents; (void)app; 
	switch(gameEvent.Type) { 
	default: gpk_warning_unhandled_event(gameEvent); break; 
...
::gpk::error_t	ssg::handleWORLD_SETUP		(::ssg::SSSiegeServer & world, const ::ssg::EViewWorldSetup & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { 
...
::gpk::error_t	ssg::handleWORLD_VALUE		(::ssg::SSSiegeServer & world, const ::ssg::EViewWorldValue & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { 
	(void)outputEvents; (void)world; 
	switch(gameEvent.Type) { 
	default: gpk_warning_unhandled_event(gameEvent); break; 
