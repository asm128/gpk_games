...
namespace ssg
{
	stct SSiegeServerMessage { ::ssg::ssiegeid_t Id; ::ssg::EventSSiege Event; };

	stct SSiegeServer : ::ssg::SSiegeApp {
	...
	stin ::gpk::error_t	handleACT_SAILING		(::ssg::SSiegeServer & world, const ::gpk::SEventView<ssg::ACT_SAILING> & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { (void)world, (void)gameEvent, (void)outputEvents; return 0; }
	stin ::gpk::error_t	handleACT_ENGINES		(::ssg::SSiegeServer & world, const ::gpk::SEventView<ssg::ACT_ENGINES> & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { (void)world, (void)gameEvent, (void)outputEvents; return 0; }
	stin ::gpk::error_t	handleACT_AIRSHIP		(::ssg::SSiegeServer & world, const ::gpk::SEventView<ssg::ACT_AIRSHIP> & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { (void)world, (void)gameEvent, (void)outputEvents; return 0; }
	stin ::gpk::error_t	handleACT_WHEELED		(::ssg::SSiegeServer & world, const ::gpk::SEventView<ssg::ACT_WHEELED> & gameEvent, ::gpk::apobj<::ssg::EventSSiege> & outputEvents) { (void)world, (void)gameEvent, (void)outputEvents; return 0; }
