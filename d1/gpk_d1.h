...
#pragma pack(pop)
	...
	::gpk::error_t							theOneUpdate				(::d1::SD1 & app, double secondsElapsed, const ::gpk::pobj<::gpk::SInput> & inputState, const ::gpk::view<::gpk::SSysEvent> & systemEvents);
	::gpk::error_t							theOneDraw					(::d1::SD1UI & appUI, ::d1::SD1Game & poolGame, ::gpk::rt<::gpk::bgra, uint32_t> & backBuffer, double totalSeconds, bool onlyGUI = false);
