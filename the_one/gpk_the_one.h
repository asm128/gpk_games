...
#pragma pack(push, 1)
	struct STheOneLogo {
		::gpk::SCoord3<float>					T[8]						= {};
		::gpk::SCoord3<float>					H[12]						= {{-1, 0}, {-2, 0}, {-2, 8}, {-1, 9}, };
		::gpk::SCoord3<float>					E[12]						= {};

		::gpk::SCoord3<float>					o[8]						= {};
		::gpk::SCoord3<float>					n[10]						= {};
		::gpk::SCoord3<float>					e[12]						= {};
	};
#pragma pack(pop)
	...
	struct STheOneGame {
		...
		::gpk::apod<::the1::SContactBall>		ContactsToDraw				= {};
	...
	::gpk::error_t							theOneDraw			(::the1::STheOne & app, ::gpk::rt<::gpk::SColorBGRA, uint32_t> & backBuffer, double totalSeconds, bool onlyGUI = false);
