...
::gpk::error_t							cleanup							(::SApplication & app)						{ 
	...
	//::ohg::openHellUpdate(app.OpenHellApp, framework.FrameInfo.Seconds.LastFrame, framework.Input, framework.RootWindow.EventQueue);
...
int										update				(SApplication & app, bool exitSignal)	{
	...
	//if(1 == ::ghg::galaxyHellUpdate(app.OpenHellApp, framework.FrameInfo.Seconds.LastFrame, framework.Input, framework.RootWindow.EventQueue))
...
int														draw					(SApplication & /*app*/) {
    ...
    //glEnd();
    //glFlush();
	return 0; //::ohg::openHellDraw(app.OpenHellApp, app.Framework.RootWindow.Size.Cast<uint16_t>());
}
