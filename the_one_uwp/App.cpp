...
namespace the_one_uwp
{
	...
	protected:
		...
		void			OnWindowSizeChanged				(Windows::UI::Core::CoreWindow^ sender, Windows::UI::Core::WindowSizeChangedEventArgs^ args)	{ DeviceResources->SetLogicalSize({sender->Bounds.Width, sender->Bounds.Height}); UserUWP->CreateWindowSizeDependentResources(); }
